...
CMD ["sh", "-c", "echo '🚀 Iniciando aplicación Shalom API...' && echo '⚙️ Generando cliente Prisma...' && npx prisma generate --schema=./prisma/schema.prisma && echo '📦 Ejecutando migraciones...' && npx prisma migrate deploy && echo '🔧 Inicializando datos con Prisma DB...' && npx prisma db seed || echo 'Seed completado o no necesario' && echo '🌟 Iniciando servidor...' && npm start"]
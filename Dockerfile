...
CMD ["sh", "-c", "echo '🚀 Iniciando aplicación Shalom API...' && echo '⚙️ Generando cliente Prisma...' && npx prisma generate --schema=./prisma/schema.prisma && echo '🔍 Verificando cliente Prisma...' && ls -la node_modules/.prisma/client/ && echo '📦 Ejecutando migraciones...' && npx prisma migrate deploy && echo '🔧 Inicializando datos...' && node scripts/create-user.js admin@shalom.com 'Administrador' && echo '🌟 Iniciando servidor...' && npm start"]D